...
describe('Checkbox snapshots', () => {
    it('unchecked', () => {
        const { container } = render(
            <Checkbox label="Restart on crash" checked={false} onChange={vi.fn()} />,
        )
    ...
    it('checked', () => {
        const { container } = render(
            <Checkbox label="Restart on crash" checked onChange={vi.fn()} />,
        )
        expect(container.firstChild).toMatchSnapshot()
    })
...
describe('Input snapshots', () => {
    ...
    it('TextInput mono', () => {
        const { container } = render(
            <TextInput value="C:/SimHub/SimHub.exe" onChange={vi.fn()} mono />,
        )
        expect(container.firstChild).toMatchSnapshot()
    })
...
describe('Badge snapshots', () => {
    ...
    it('StatusBadge idle', () => {
        const { container } = render(<StatusBadge status={undefined} enabled label="Idle" />)
        expect(container.firstChild).toMatchSnapshot()
    })
...
describe('FormField snapshot', () => {
    ...
    it('with hint', () => {
        const { container } = render(
            <FormField label="Name" hint="Display name">
                <input />
            </FormField>,
        )
        expect(container.firstChild).toMatchSnapshot()
